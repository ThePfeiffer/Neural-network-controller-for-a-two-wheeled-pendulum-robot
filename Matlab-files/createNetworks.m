function [criticNetwork1, criticNetwork2, actorNetwork] = createNetworks(numObs, numAct, layerSize, actionLimit)
...
clsz = [layerSize layerSize]; % Critic layer sizes
...
alsz = [layerSize layerSize]; % Actor layer sizes
actorNetwork = [
    ...
    tanhLayer(Name = 'tanh')
    scalingLayer(Name="scale",Scale = actionLimit)
    ];
