function agent = createTD3Agent(numObs, obsInfo, numAct, actInfo, Ts, layerSize, actionLimit, LearningRate)
% Walking Robot -- TD3 Agent Setup Script
% Copyright 2020 The MathWorks, Inc.
% adapted by Emil Pfeiffer Kristensen, 2026

%% Create the actor and critic networks using the createNetworks helper function
[criticNetwork1,criticNetwork2,actorNetwork] = createNetworks(numObs,numAct, layerSize, actionLimit);
...
%% Create agent using specified actor, critic and agent options
